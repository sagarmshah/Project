...
========================================================== */
(function( $ ){
  $.fn.addimage = function(url,image) {
  
       var parent = document.getElementById("soc_image");
			var li =document.createElement("li");
			var p = '<a href="'+url+'"><img src="img/socials/'+image+'.png" alt="" /></a>';
			li.innerHTML = p;
...
(function($)
	{	
		$.fn.mobilyblocks=function(options)
			{	var defaults={trigger:"click",direction:"clockwise",duration:750,zIndex:10,widthMultiplier:1.2};
								...
								,hover:function()
								{
									...
									trigger.bind("mouseover",function()
										{	if(hov==false)
												{
													parent.fadeTo(sets.duration,1);
													socials.animation.open();$t.addClass("close")
												}
										});
												...
												open:function()
													{
														...
														list.each(function(i)
															{	var li=$(this);
																li.animate({path:new $.path.arc({center:[0,0],radius:w*sets.widthMultiplier,start:0,end:360/size*i,dir:dir})},sets.duration)
															});
														list.hover(function()
															{
																var li=$(this);
