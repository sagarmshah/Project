...
<section>
  <h1>LIVE STREAMING</h1>
   ...
   <form name="form1" method="post" action="updatevideos.php">
     <label for="videos"></label>
     Link : <textarea name="videos" id="videos" cols="45" rows="5"><?php $result_set= mysql_query("SELECT * 
FROM  `videos`  
LIMIT 0 , 30");  
	...
	?></textarea>
  <br/><br/><br/>  <input type="submit" name="updatevideos" id="updatevideos" value="Update Page">
   </form>
